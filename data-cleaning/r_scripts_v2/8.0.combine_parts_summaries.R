combine_parts_summaries <- function(combined_summary) {
  final_combined_summaries <- list(
    ...
    final_pat_memcat_parent_mapped = unique(rbindlist(lapply(combined_summary, `[[`, "pat_memcat_parent_mapped"))),
    final_pat_memcat_child_mapped = unique(rbindlist(lapply(combined_summary, `[[`, "pat_memcat_child_mapped"))),
