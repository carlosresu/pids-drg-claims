...
# combine_replacement_tables <- function(rboundlist) {
#   combined <- rboundlist
#   if (nrow(combined) == 0) {
#     return(data.table(
#       Column = character(),
...
# combine_replace_na_tables <- function(rboundlist) {
#   combined <- rboundlist
#   if (nrow(combined) == 0) {
#     return(data.table(
#       Column = character(),
...
#   return(combined[, .(
#     Empty_Replaced = sum(Empty_Replaced, na.rm = TRUE),
#     String_NA_Replaced = sum(String_NA_Replaced, na.rm = TRUE),
#     Actual_NA_Replaced = sum(Actual_NA_Replaced, na.rm = TRUE)
#   ), by = Column][order(-Empty_Replaced, -String_NA_Replaced, -Actual_NA_Replaced)])
# }

# final_combine_replace_tables <- function(rboundlist, samplesizedivisor = sample_size_divisor, splitparts = split_parts, totalrows = total_rows) {
