---
title: An R Markdown document converted from "/home/resurreccion_cmc_gmail_com/drg-pipeline/data-cleaning/drg-cleaning.ipynb"
...
```{r}
main <- py_run_string("import sys; x=sys.version")
main$x
```
