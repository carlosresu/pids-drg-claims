...
#   ## Column formats
#   integer_cols <- c("ADMISSION_YEAR", "IS_ADMISSION_OPD", "IS_EMERGENCY_CASE")

#   factor_cols <- c(
#     "PATIENT_TYPE", "ROOM_TYPE", "PATIENT_RELATIONSHIP", "PATIENT_SEX", "MEMCAT_PARENT_DESC",
#     "MEMCAT_CHILD_DESC", "PATIENT_DISPOSITION", "CLAIM_STATUS"
#   )
#   numeric_cols <- c(
#     "PATIENT_AGE", "PAT_BWT_KG", "CLAIM_PAID_AMOUNT",
#     "CLAIM_AMOUNT_ACTUAL"
#   )

#   character_cols <- c(
#     "CLAIM_SERIES_ID", "PIN", "HCI_PMCC_NO", "HCP_NO_LIST",
#     "PRIMARY_ILLNESS", "SECONDARY_ILLNESS", "ICDCODES_ITEM7",
#     "RVSCODES_ITEM7", "ADMISSION_DATE", "ADMISSION_TIME",
#     "DISCHARGE_DATE", "DISCHARGE_TIME", "RECEIVE_DATE", "REFILE_DATE", "CHECK_DATE",
...
#   old_colnames <- c(
#     "ADMISSION_YEAR", "CLAIM_SERIES_ID", "PIN", "ADMISSION_DATE",
#     "ADMISSION_TIME", "DISCHARGE_DATE", "DISCHARGE_TIME",
#     "RECEIVE_DATE", "REFILE_DATE", "CHECK_DATE", "EXTRACTION_DATE",
#     "HCI_PMCC_NO", "HCP_NO_LIST", "PATIENT_TYPE", "PATIENT_RELATIONSHIP",
#     "PATIENT_SEX", "PATIENT_AGE", "MEMCAT_PARENT_DESC", "MEMCAT_CHILD_DESC",
#     "IS_ADMISSION_OPD", "IS_EMERGENCY_CASE", "ROOM_TYPE",
#     "PATIENT_DISPOSITION", "PRIMARY_ILLNESS", "SECONDARY_ILLNESS",
#     "ICDCODES_ITEM7", "RVSCODES_ITEM7", "CLAIM_STATUS", "CLAIM_PAID_AMOUNT",
#     "CLAIM_AMOUNT_ACTUAL"
#   )
...
#     "clin_discharge", "clin_c1", "clin_c2",
#     "clin_icd", "clin_rvs",
#     "claim_status", "claim_payout", "claim_charge"
#   )
# } else {
#   ## Mapping of column names
#   old_colnames <- c(
